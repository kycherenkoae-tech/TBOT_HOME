...
def check_offline():
    """Перевіряє, чи ESP офлайн і відправляє повідомлення"""
    global is_offline
    if not last_seen:
        return
...
def esp_watcher():
    """Безперервно перевіряє ESP кожні 30 секунд"""
    while True:
        check_offline()
...
if __name__ == "__main__":
    ...
    # ESP watcher (постійна перевірка онлайн/офлайн)
